      ...
      <aside className="LeftSide">
        <nav className="Navbar">
          <ul className="navbar__list">
            <NavBarItem itemText={"Моя страница"} badgeNumber={1} />
            <NavBarItem itemText={"Новости"} badgeNumber={2} />
            <NavBarItem itemText={"Чаты"} badgeNumber={3} />
            <NavBarItem itemText={"Друзья"} badgeNumber={4} />
            <NavBarItem itemText={"Группы"} badgeNumber={5} />
            <NavBarItem itemText={"Фотографии"} badgeNumber={6} />
            <NavBarItem itemText={"Видео"} badgeNumber={7} />
            <NavBarItem itemText={"Музыка"} badgeNumber={8} />
            <NavBarItem itemText={"Сохраненное"} badgeNumber={9} />
            <NavBarItem itemText={"Другое"} badgeNumber={100} />
          </ul>
        </nav>
        {/* <div className="List">
